...
namespace Assets.Code.Core.Installers
{
    public class GameInstaller : GeneralInstaller
    {
        ...
        [SerializeField] private CloudsConfiguration _cloudsConfiguration;
        ...
        private void InstallCloudsFactory()
        {
            var cloudsFactory = new CloudsFactory(Instantiate(_cloudsConfiguration),
                                ServiceLocator.Instance.GetService<MapsAndLevelsSystem>().GetLastMapPlayed());
            ServiceLocator.Instance.RegisterService(cloudsFactory);
        }
        ...
        private void OnDestroy()
        {
            ...
            ServiceLocator.Instance.UnregisterService<CloudsFactory>();
