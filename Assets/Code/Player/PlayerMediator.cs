...
namespace Assets.Code.Player
{
    public class PlayerMediator : MonoBehaviour, EventObserver
    {
        ...
        private void Start()
        {
            ...
            eventQueue.Subscribe(EventIds.SendJoystick, this);
        ...
        private void OnDestroy()
        {
            ...
            eventQueue.Unsubscribe(EventIds.SendJoystick, this);
        }
        ...
        public void Configure(PlayerConfiguration configuration)
        {
            ...
            _playerStatsController.ConfigureTrail(configuration.TrailHp, configuration.TrailFire,
                                             ...
                                             configuration.TrailSpeed, configuration.TrailTurnSpeed);
            ...
            _playerSpriteAndColliderController.Configuration(configuration.UnevolvedSprite, configuration.EvolvedSprite,
                                                             configuration.UnevolvedFirstColliderOffset, configuration.UnevolvedFirstColliderSize,
                                                             configuration.UnevolvedSecondColliderOffset, configuration.UnevolvedSecondColliderSize,
                                                             configuration.EvolvedFirstColliderOffset, configuration.EvolvedFirstColliderSize,
                                                             configuration.EvolvedSecondColliderOffset, configuration.EvolvedSecondColliderSize,
                                                             configuration.Level);
            _playerMovementController.ConfigureMovement(configuration.TrailSpeed, configuration.TrailTurnSpeed);
        ...
        private void Update()
        {
            ...
            {
                _playerMovementController.GetTurnDirection();
            }
        }
        ...
        public void Process(EventData eventData)
        {
            ...
            if (eventData.EventId == EventIds.ProjectileDestroyed)
            {
                ...
                {
                    StoreProjectileName(projectileDestroyedEventData.ProjectileId);
            ...
            if (eventData.EventId == EventIds.SwordEquippedLevelUp)
            {
                ...
                if (ServiceLocator.Instance.GetService<SwordEquippedSystem>().GetSwordEquipped() == swordEquippedLevelUpEventData.Id)
                {
                    _playerStatsController.ConfigureTrail(swordEquippedLevelUpEventData.Hp, swordEquippedLevelUpEventData.Fire,
                                             ...
                                             swordEquippedLevelUpEventData.Speed, swordEquippedLevelUpEventData.TurnSpeed);
            ...
            if (eventData.EventId == EventIds.SendJoystick)
            {
                var joystickEventData = (JoystickEventData)eventData;
                _playerMovementController.SetJoystick(joystickEventData.Joystick);
            }
        }
    }
}