...
namespace Assets.Code.Ads
{
    public class RewardedAdsButton : MonoBehaviour, IUnityAdsLoadListener, IUnityAdsShowListener, EventObserver
    {
        ...
        private string _spinWheelReward = "AirplaneRewardedFortuneWheel";
        private string _rewardMultiplierX3 = "AirplaneRewardedVictoryX3";
        private string _gameOverExtraLife = "AirplaneRewardedGameOverExtra";
