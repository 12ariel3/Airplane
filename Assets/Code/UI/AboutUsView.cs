...
namespace Assets.Code.UI
{
    public class AboutUsView : MonoBehaviour
    {
        ...
        {
            Application.OpenURL("https://www.privacypolicies.com/live/4addd3e5-9ef7-4987-a3dc-d80bbecb9aea");
        }
        ...
        private void CheckForInnAppReview()
        {
            if (Application.platform == RuntimePlatform.Android)
            {
                ...
                {
                    Application.OpenURL("https://play.google.com/store/apps/details?id=com.BlueScorpioStudio.Airplane");
                }
            }
        }
