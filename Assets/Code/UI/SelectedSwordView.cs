    ...
    public class SelectedSwordView : MonoBehaviour
    {
        ...
        private void SetSelectedSword()
        {
            var swordEquipedEventData = new SwordEquipedEventData(_swordSpriteUnevolved, _swordSpriteEvolved, _upgradeValue, _id, _level,
                                                                  ...
                                                                  _electric, _ghost, _rainbow, _speed, _turnSpeed,
                                                                  _deepBackground, _background, _iconBackground,
                                                                  _nameColor, _levelColor, _unevolvedFirstColliderOffset, _unevolvedFirstColliderSize,
                                                                  _unevolvedSecondColliderOffset, _unevolvedSecondColliderSize,
                                                                  _evolvedFirstColliderOffset, _evolvedFirstColliderSize,
                                                                  _evolvedSecondColliderOffset, _evolvedSecondColliderSize, GetInstanceID());
            ...
            if (_level < 100)
            {
                ...
                if (_totalScore >= _upgradeValue)
                {
                    ...
                    if(_level == 49)
                    {
                        ...
                        var swordLvlUpPopUp50EventData = new SwordLvlUpPopUp50EventData(_swordImage.transform.position, GetInstanceID());
        ...
        public void SetStadistics(Sprite swordSpriteUnevolved, Sprite swordSpriteEvolved, int swordUpgradeValue, string swordName, int swordLevel,
                                  ...
                                  float swordGhost, float swordRainbow, float swordSpeed, float swordTurnSpeed, Color deepBackground,
                                  Color background, Color iconBackground, Color nameColor, Color levelColor, Vector2 unevolvedFirstColliderOffset,
